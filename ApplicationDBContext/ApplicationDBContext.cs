...
public class ApplicationDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Relationship>().HasKey(r => new { r.FromPerson, r.ToPerson });
        modelBuilder.Entity<Relationship>().HasOne(r => r.FromPerson).WithMany(p => p.RelationshipFrom).HasForeignKey(r => r.FromPersonId);
        modelBuilder.Entity<Relationship>().HasOne(r => r.ToPerson).WithMany(p => p.RelationshipTo).HasForeignKey(r => r.ToPersonId);
        ...
        modelBuilder.Entity<PhoneNumber>().HasOne(p => p.PersonId).WithMany(p => p.PhoneNumbers).HasForeignKey(p => p.PersonId);
